...
<script src="/metalist/js/jquery.js"></script>
...
<script src="/metalist/js/popup.js"></script>
<script src="/metalist/js/popup1.js"></script>
<script src="/metalist/js/uploadpopup.js"></script>
<script src="/metalist/js/meetuppopup.js"></script>
...
<link rel="stylesheet" type="text/css" href="\metalist\css\goalzone.css">
<link rel="stylesheet" type="text/css" href="\metalist\css\setgoal.css">
<link rel="stylesheet" type="text/css" href="\metalist\css\invite.css">
<link rel="stylesheet" type="text/css" href="\metalist\css\upload.css">
<link rel="stylesheet" type="text/css" href="\metalist\css\setmeetup.css">



<title>Metalist | Goal Zone</title>
</head>
<!--code for popup  -->
<body>
...
<!--cod for invite popup  -->
<s:div cssClass="maindiv">
<s:form action="inviteAction" theme="simple">
<s:div cssClass="invitepop">
<s:div cssClass="ihead">Invite Friends!!!
<s:div cssClass="cancel2"><img src="img/cancle2.png" width="100%" height="100%"/>
	</s:div>
	</s:div>
<table cellpadding="10px" style="padding-top: 20px;padding-left:25px;">
<tr>
<td>
</td>
</tr>
<tr>
<td>
<s:textfield cssClass="tomail" name="send" placeholder="To:"></s:textfield>
</td>
</tr>
<tr>
<td>
<s:textfield cssClass="subject" name="subject" placeholder="sub / Title:"></s:textfield>
</td>
</tr>

<tr>
<td>
<s:textarea cssClass="message" name="message" placeholder="message Body:"></s:textarea>
</td>
</tr>
</table>
...
<tr>
<td>
<s:submit value="Send" cssClass="btn1"></s:submit>
<s:reset value="Cancel" cssClass="btn1"></s:reset>
</td>
</tr> 
</table>
</s:div>
...
<tr>
<td>
<s:file  name="imageupload" cssClass="imageupload"></s:file>
</td>
</tr>
<tr>
<td>
...
<!--code for meetup schedule popup  -->
<s:div cssClass="meetupmaindiv">
<s:form action="#" theme="simple">
<s:div cssClass="meetup">
<s:div cssClass="mhead">Schedule Meetups here!!!
...
<tr>
<td>
<s:textarea cssClass="meetupgoal" name="meetupgoal" placeholder="Goal name for which meetup is scheduled..."></s:textarea>
</td>
</tr>
<tr>
<td>
<s:textarea cssClass="meetupdescription" name="meetupdescription" placeholder="Description about meetup...."></s:textarea>
</td>
</tr>
<tr>
<td>
<s:textfield cssClass="meetupdate" id="meetupdatepicker" name="meetupdate" placeholder="Date of meetup..."></s:textfield>
&nbsp;&nbsp;<s:textfield cssClass="meetuptime" name="edate" placeholder="Time of meetup..."></s:textfield>

</td>
</tr>
<tr>
<td>
<s:textfield cssClass="meetuplocation" name="meetuploction" placeholder="enter specific location for meetup...."></s:textfield>
</td>
</tr>
<tr>
<td>
<s:textarea cssClass="meetupaddress" name="meetupaddress" placeholder="compelete address of meetup place..."></s:textarea>
</td>
</tr>
		...
		<s:div cssClass="container">
			...
			<s:div cssClass="middlecontainer">
                ...
                <s:div cssClass="activity">
                   <s:div cssClass="heading"><h3 style="text-align:left;padding-left: 10px;margin-top:5px;color:white;">My Goals !!!</h3></s:div>
                   ...
                   <s:textarea cssClass="description" name="goaldescription"></s:textarea>
                    ...
                    <s:div cssClass="date"><s:div cssClass="sdate"><h3>Start Date:</h3></s:div><s:div cssClass="text"><s:textfield cssStyle="background-color:#e6e6e6;outline:none;"></s:textfield> </s:div></s:div> 
                   <s:div cssClass="date"><s:div cssClass="edate"><h3>End Date:</h3></s:div><s:div cssClass="text1"><s:textfield cssStyle="background-color:#e6e6e6;outline:none;"></s:textfield> </s:div></s:div>
                    <s:div cssClass="due">
                    <s:div cssClass="days"><h3>Due Days:</h3></s:div><s:div cssClass="text2"><s:textfield cssStyle="background-color:#e6e6e6;outline:none;width:75px;"></s:textfield> </s:div>
                    <s:div cssClass="member"><h3>Members:</h3></s:div><s:div cssClass="text3"><s:textfield cssStyle="background-color:#e6e6e6;outline:none;width:75px;"></s:textfield> </s:div>
                    </s:div>
                    <s:div cssClass="bottom_btn">
                      <s:div cssClass="invite">Invite</s:div>
                      <s:div cssClass="upload">Upload</s:div>
                      <s:div cssClass="show">Download</s:div>
                      <s:div cssClass="meetuplink">Meetups</s:div>
                    </s:div>
                    </s:div> 
            </s:div>
