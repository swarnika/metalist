...
<link rel="stylesheet" type="text/css" href="\metalist\css\meetup.css">
	...
	<s:div cssClass="maincontainer" id="main">
		...
		<s:div cssClass="container">
			<s:div cssClass="leftcontainer">
				...
				<s:div cssClass="button1">
					<h3 id="h3tag"><s:a id="link" href="#">Meetup Schedule</s:a></h3>
				</s:div>
				<s:div cssClass="button1">
			...
			<s:div cssClass="middlecontainer">
                ...
                <s:div cssClass="activity">
                   <s:div cssClass="heading"><h3 style="text-align:left;padding-left: 10px;margin-top:5px;color:white;">Meetup Scheduals  !!!</h3></s:div>
                   <s:div><h3 style="text-align:left;padding-left: 10px;margin-top:5px;color:#ef539d;padding-left:20px;padding-top:20px; ">Goal Title</h3></s:div>
                   <s:div cssClass="date"><s:div cssClass="sdate"><h3>Date:</h3></s:div><s:div cssClass="text"><s:textfield cssStyle="background-color:#e6e6e6;outline:none;" name="meetupdate"></s:textfield> </s:div></s:div> 
                   <s:div cssClass="date"><s:div cssClass="edate"><h3>Time:</h3></s:div><s:div cssClass="text1"><s:textfield cssStyle="background-color:#e6e6e6;outline:none;" name="meetuptime"></s:textfield> </s:div></s:div>
                    <s:div cssClass="due">
                    <s:div cssClass="days"><h3>Location</h3></s:div><s:div cssClass="text2"><s:textfield cssStyle="background-color:#e6e6e6;outline:none;" name="meetuplocation"></s:textfield> </s:div>
                    </s:div>
                    <s:div cssClass="bottom_btn">
                      <s:a action="goingmail"><s:div cssClass="invite">Going</s:div></s:a>
                      <s:div cssClass="show">Not going</s:div>
                      <s:div cssClass="meetuplink">Invite</s:div>
                    </s:div>
                    </s:div> 
            </s:div>
